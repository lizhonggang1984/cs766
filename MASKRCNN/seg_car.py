...
car_MODEL_PATH = os.path.join(ROOT_DIR, "mask_rcnn_car_1000_30_0_night.h5")
...
TEST_IMAGE_DIR = os.path.join(ROOT_DIR, "/datasets/test2")
...
file_names = ['b1d22449-117aa773-0000001.jpg']

TEST_IMAGE_DIR = './datasets/test2'

for i in range(1):
    # Load a random image from the images folder
    image = skimage.io.imread(os.path.join(TEST_IMAGE_DIR, file_names[i]))    # Run detection
